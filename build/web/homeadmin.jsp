      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i>Active Clients</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Expired Clients</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Client</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Guard</a></li>
...
<script>
 ...
 function addAdmin() {
				...
				xhttp.open("POST","AddAdmin.jsp",true);
				xhttp.send();
			}
 ...
 function addClient() {
				...
				xhttp.open("POST","AddClient.jsp",true);
				xhttp.send();
			}
